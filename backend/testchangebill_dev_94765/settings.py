"""
Django settings for testchangebill_dev_94765 project.
...
ROOT_URLCONF = 'testchangebill_dev_94765.urls'
...
WSGI_APPLICATION = 'testchangebill_dev_94765.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testchangebill_dev_94765 API",
    "DESCRIPTION": "API documentation for testchangebill_dev_94765 App",
    "VERSION": "v1",
}
