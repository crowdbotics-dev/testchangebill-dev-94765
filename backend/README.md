...
## Project Structure
    ...
    ├── testchangebill_dev_94765  # Django project configurations
...
1. Clone this repo and `cd testchangebill_dev_94765`
...
2. Clone this repo and `cd testchangebill_dev_94765`
